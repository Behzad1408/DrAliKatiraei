 document.addEventListener('DOMContentLoaded', function() {
            // --- بخش مربوط به منوی اصلی و اسکرول ---
            ...
            // --- بخش جدید: مربوط به پاپ‌آپ مراقبت‌های پس از درمان ---
            ...
            careButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    modalContent.innerHTML = carePlans[service] || '<p>اطلاعاتی برای این خدمت ثبت نشده است.</p>';
